      ...
      switch (field) {
        ...
        case 'states': {
          return [
            ...
            {id: 8, title: 'Delaware'},
            {id: 9, title: 'District of Columbia'},
            {id: 10, title: 'Florida'},
            {id: 11, title: 'Georgia'},
            {id: 12, title: 'Hawaii'},
            {id: 13, title: 'Idaho'},
            {id: 14, title: 'Illinois'},
            {id: 15, title: 'Indiana'},
            {id: 16, title: 'Iowa'},
            {id: 17, title: 'Kansas'},
            {id: 18, title: 'Kentucky'},
            {id: 19, title: 'Louisiana'},
            {id: 20, title: 'Maine'},
            {id: 21, title: 'Maryland'},
            {id: 22, title: 'Massachusetts'},
            {id: 23, title: 'Michigan'},
            {id: 24, title: 'Minnesota'},
            {id: 25, title: 'Mississippi'},
            {id: 26, title: 'Missouri'},
            {id: 27, title: 'Montana'},
            {id: 28, title: 'Nebraska'},
            {id: 29, title: 'Nevada'},
            {id: 30, title: 'New Hampshire'},
            {id: 31, title: 'New Jersey'},
            {id: 32, title: 'New Mexico'},
            {id: 33, title: 'New York'},
            {id: 34, title: 'North Carolina'},
            {id: 35, title: 'North Dakota'},
            {id: 36, title: 'Ohio'},
            {id: 37, title: 'Oklahoma'},
            {id: 38, title: 'Oregon'},
            {id: 39, title: 'Pennsylvania'},
            {id: 40, title: 'Rhode Island'},
            {id: 41, title: 'South Carolina'},
            {id: 42, title: 'South Dakota'},
            {id: 43, title: 'Tennessee'},
            {id: 44, title: 'Texas'},
            {id: 45, title: 'Utah'},
            {id: 46, title: 'Vermont'},
            {id: 47, title: 'Virginia'},
            {id: 48, title: 'Washington'},
            {id: 49, title: 'West Virginia'},
            {id: 50, title: 'Wisconsin'},
            {id: 51, title: 'Wyoming'},
            {id: 52, title: 'American Samoa'},
            {id: 53, title: 'Guam'},
            {id: 54, title: 'Northern Mariana Islands'},
            {id: 55, title: 'Puerto Rico'},
            {id: 56, title: 'United States Minor Outlying Islands'},
            {id: 57, title: 'Virgin Islands'}
          ];
        }
        default: {
          return [];
